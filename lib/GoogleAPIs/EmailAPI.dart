...
class GmailAPI {
  ...
  Future<void> sendEmail(String receiverEmail, String code) async {
    ...
    }, impersonatedUser: "bp1@kawalanseripadang.com");

    var authClient = await clientViaServiceAccount(credentials, scopes, baseClient: client);

    var gmailApi = GmailApi(authClient);
    var from = 'bp1@kawalanseripadang.com';  // The service account email
    var subject = 'Your Code';
    var body = 'Here is your code: $code';
