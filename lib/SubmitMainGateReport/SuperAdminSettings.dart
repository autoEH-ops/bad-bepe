...
class MainGateReportSuperAdminSettings {
  DocumentReference documentReference = FirebaseFirestore.instance
      .collection('Main Gate Report Settings')
      .doc('Main Gate Report Settings');
    ...
    try {
      ...
      if (!documentSnapshot.exists) {
        ...
        await documentReference.set({
          "Title 1": "Main Gate Details",
          "Title 2": "Main Gate Shutter : ",
          'Title 3': "Main Gate Status : To Be ",
          "Title 4": "Previous Main Gate : ",
