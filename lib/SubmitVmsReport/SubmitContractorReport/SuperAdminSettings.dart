...
class ContractorInReportSuperAdminSettings {
  DocumentReference documentReference = FirebaseFirestore.instance
      .collection('Contractor In Settings')
      .doc('Contractor In Settings');
    ...
    try {
      ...
      if (!documentSnapshot.exists) {
        ...
        await documentReference.set({
          "Title 1": "Contractor VMS In Pass",
          "Required 1": true,
          ...
          "Required 4": true,
          "Title 5": "Add Contractor Images",
          "Required 5": true,
          "Button 1": "Click to Submit",
          "Sub Title 1": "Select a Contractor Pass",
