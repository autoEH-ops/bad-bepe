...
import 'ManageGuestService.dart';

class ManageGUESTPage extends StatefulWidget {
  final GoogleSheets googleSheetsApi = GoogleSheets();

  ManageGUESTPage({super.key});

  @override
  State<ManageGUESTPage> createState() => _ManageContractorPageState();
}

class _ManageContractorPageState extends State<ManageGUESTPage> {
  final TextEditingController textController = TextEditingController();
  List<String> contractorNames = [];
  ManageGuestService manageContractorService = ManageGuestService();
      ...
      body: FutureBuilder<List<String>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(
              child: Text('Error loading Guest',
  ...
  void addContractorPopUp() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: const Color(0xFF1f293a),
        title:
            const Text('Add Guest', style: TextStyle(color: Colors.white)),
        content: TextField(
