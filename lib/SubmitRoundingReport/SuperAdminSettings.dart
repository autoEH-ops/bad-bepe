...
class RoundingReportSuperAdminSettings {
  DocumentReference documentReference = FirebaseFirestore.instance
      .collection('Rounding Report Settings')
      .doc('Rounding Report Settings');
    ...
    try {
      ...
      if (!documentSnapshot.exists) {
        ...
        await documentReference.set({
          "Title 1": "Rounding Reporting",
          "Title 2": "Current Rounding Point : ",
          'Title 3': "Previous Rounding Point : ",
          "Title 4": "Previous Rounding Time : ",
