...
class SpecificDutyPage extends StatefulWidget {
  const SpecificDutyPage({super.key, required this.data});

  final Map<String, dynamic> data;

  @override
  State<SpecificDutyPage> createState() => _SpecificDutyPageState();
}

class _SpecificDutyPageState extends State<SpecificDutyPage> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoBox("Visitor Pass:", widget.data["Visitor Pass"] ?? "No Data"),
