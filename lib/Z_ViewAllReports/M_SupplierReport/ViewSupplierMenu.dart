...
import 'ViewSpecificSupplier.dart';
import 'ViewSupplierService.dart';

class ViewSupplierReport extends StatefulWidget {
  const ViewSupplierReport({super.key});

  @override
  State<ViewSupplierReport> createState() => _ViewSupplierReportState();
}

class _ViewSupplierReportState extends State<ViewSupplierReport> {
  final TextEditingController textController = TextEditingController();
  DateTime? _startDate;
  DateTime? _endDate;

  ViewSupplierService viewSupplierService = ViewSupplierService();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<Map<String, String>>>(
        future: viewSupplierService.getAllHourly(),
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SpecificSupplierPage(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Created for: ${filteredReports[index]['names'] ?? 'N/A'}",
                                style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
                                softWrap: true,
                                overflow: TextOverflow.visible,
                              ),
