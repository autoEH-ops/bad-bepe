...
class SpecificSupplierPage extends StatefulWidget {
  const SpecificSupplierPage({super.key, required this.data});

  final Map<String, dynamic> data;

  @override
  State<SpecificSupplierPage> createState() => _SpecificSupplierPageState();
}

class _SpecificSupplierPageState extends State<SpecificSupplierPage> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoBox("Created for:", widget.data["names"] ?? "No Data"),
              _buildInfoBox("Report by:", widget.data["email"] ?? "No Data"),
              _buildInfoBox("Supplier Pass:", widget.data["SupplierPass"] ?? "No Data"),
