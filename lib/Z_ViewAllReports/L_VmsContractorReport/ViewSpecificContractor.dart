...
class SpecificContractorPage extends StatefulWidget {
  const SpecificContractorPage({super.key, required this.data});

  final Map<String, dynamic> data;

  @override
  State<SpecificContractorPage> createState() => _SpecificContractorPageState();
}

class _SpecificContractorPageState extends State<SpecificContractorPage> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoBox("Contractor Pass:", widget.data["Contractor Pass"] ?? "No Data"),
