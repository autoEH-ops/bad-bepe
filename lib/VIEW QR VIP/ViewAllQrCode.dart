...
class AllVVQrCodePage extends StatefulWidget {
  const AllVVQrCodePage({
    super.key,
    required this.email,
    required this.role,
  });
  ...
  @override
  State<AllVVQrCodePage> createState() => _AllVVQrCodePage();
}

class _AllVVQrCodePage extends State<AllVVQrCodePage> {
  ...
  Widget build(BuildContext context) {
    final allQrService = AllVVQrService();
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => OneVVQrCodePage(
                qrData: documentID,
                email: widget.email,
                role: widget.role,
              ),
