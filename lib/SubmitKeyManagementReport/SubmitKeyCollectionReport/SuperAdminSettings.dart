...
class KeyCollectionReportSuperAdminSettings {
  DocumentReference documentReference = FirebaseFirestore.instance
      .collection('Key Collection Settings')
      .doc('Key Collection');
    ...
    try {
      ...
      if (!documentSnapshot.exists) {
        ...
        await documentReference.set({
          ...
          "Required 4": true,
          "Title 5": "photo of handed key or ID",
          "Required 5": true,
          "Button 1": "Click to Submit",
          "Sub Title 1": "Select a Key",
